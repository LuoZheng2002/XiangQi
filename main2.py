...
try:
    ...
    while True:
        ...
        whose_turn = run_dynamic_code(cid_of['func::who_is_next_func'], AGIList([current_chessboard]), cid_of, dir_list)
        ...
        if end_game.concept_id == cid_of['True']:
            ...
            red_benefit = run_dynamic_code(cid_of['func::end_game_benefit'],
                                           AGIList([current_chessboard, obj('xq::red_team', cid_of)]), cid_of, dir_list)
            black_benefit = run_dynamic_code(cid_of['func::end_game_benefit'],
                                             AGIList([current_chessboard,
                                                      obj('xq::black_team', cid_of)]), cid_of, dir_list)
